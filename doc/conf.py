...
project = u'mealy'
copyright = u'2020-%s, Dataiku' % date.today().year
...
version = mealy.__version__
# The full version, including alpha/beta/rc tags.
release = mealy.__version__ + '-git'
...
# of the sidebar.
html_logo = '_static/Logo_mealy_final.png'
...
latex_documents = [
    ('index', 'mealy.tex', u'mealy Documentation',
     u'Dataiku', 'manual'),
]
...
man_pages = [
    ('index', 'mealy', u'mealy Documentation',
     ['mealy'], 1)
]
...
texinfo_documents = [
    ('index', 'mealy', u'mealy Documentation',
     'Dataiku', 'mealy', 'One line description of project.',
     'Miscellaneous'),
]
